...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/Luxorv/.rbenv/versions/2.3.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/Luxorv/.rbenv/versions/2.3.0' '--with-openssl-dir=/usr/local/opt/openssl' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/Luxorv/.rbenv/versions/2.3.0/lib ' 'CPPFLAGS=-I/Users/Luxorv/.rbenv/versions/2.3.0/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/Luxorv/.rbenv/versions/2.3.0"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/Luxorv/.rbenv/versions/2.3.0/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/Luxorv/.rbenv/versions/2.3.0/lib  -fstack-protector"
